...
from hte_agent.shared.candidate_schema import PrecedentRecord
...
def load_historical_dataset(dataset_root: str) -> HistoricalDataset:
    ...
    precedent_rows = read_csv_rows(base / "precedent_records.csv")
    success_rows = read_csv_rows(base / "success_support.csv")
    failure_rows = read_csv_rows(base / "failure_support.csv")
