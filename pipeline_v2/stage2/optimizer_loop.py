...
from pipeline_v2.shared.candidate_schema import Candidate, Observation, Stage2Score, TrustRegion
from pipeline_v2.shared.io_utils import bounded, safe_divide
from pipeline_v2.stage2.trust_region import trust_region_bonus


class MixedBatchBO:
    """Small mixed-space BO surrogate using similarity-weighted local regression."""
